...
2. Search for "Hansisi's Utility Mod".
...
- If make.py doesn't work, you can either use `python3 make.py` or you can manually create a zip file of the mod folder and name it `utility-mod_version.zip` before moving it to the mods directory. (If you do this rename the src folder to utility-mod and the zip file to utility-mod_version.zip, where version is the version number in info.json)
